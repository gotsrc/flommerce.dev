                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs-center">
                                            <a href="{{ route('reduce', ['id' => $product['item']['id']])}}" class="tag tag-default"><i class="fa fa-minus"></i></a>
                                            <span style="margin: 0 10px;">{{ $product['quantity'] }}</span>
                                            <a href="{{ route('increment', ['id' => $product['item']['id']]) }}" class="tag tag-default"><i class="fa fa-plus"></i></a>
                                        </td>
                                        <td class="text-xs-center"><a href="{{ route('remove-all', ['id' => $product['item']['id']]) }}" class="fa fa-remove"></a></td>
